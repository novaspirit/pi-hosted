...
sudo wget -O /portainer/Files/AppData/Config/drupal/sites/default/default.settings.php https://raw.githubusercontent.com/novaspirit/pi-hosted/master/configs/drupal/drupal/default/default.settings.php || error "Failed to download default.settings.php file!"
